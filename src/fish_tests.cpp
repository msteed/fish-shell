...
static void test_string(void)
{
    ...
    string_tests[] =
    {
        ...
        { {L"string", L"match", L"-r", L"-m1", L"a", L"x", L"a", L"x", L"a", 0}, 0, L"a\n" },
        { {L"string", L"match", L"-r", L"-m1", L"a[bc]", L"abadac", 0},     0, L"ab\n" },
        ...
        { {L"string", L"match", L"-r", L"-m1", L"(a)b(c)", L"abcabc", 0},   0, L"abc\na\nc\n" },
        { {L"string", L"match", L"-r", L"(a|(z))(bc)", L"abc", 0},          0, L"abc\na\nbc\n" },
        { {L"string", L"match", L"-r", L"-n", L"a", L"a", 0},               0, L"1\n" },
        { {L"string", L"match", L"-r", L"-n", L"a", L"bacadae", 0},         0, L"2\n4\n6\n" },
        { {L"string", L"match", L"-r", L"-n", L"-m2", L"a", L"bacadae", 0}, 0, L"2\n4\n" },
        { {L"string", L"match", L"-r", L"-n", L"(a).*(b)", L"a---b", 0},    0, L"1\n1\n5\n" },
        { {L"string", L"match", L"-r", L"-n", L"-m1", L"(a)(b)", L"ab", 0}, 0, L"1\n1\n2\n" },
        { {L"string", L"match", L"-r", L"-n", L"-m1", L"(a)(b)", L"abab", 0}, 0, L"1\n1\n2\n" },
        { {L"string", L"match", L"-r", L"-n", L"-m2", L"(a)(b)", L"abab", 0}, 0, L"1\n1\n2\n3\n3\n4\n" },
        ...
        { {L"string", L"replace", L"-m2", L"-i", L"a", L"z", L"AAA", 0},    0, L"zzA\n" },
